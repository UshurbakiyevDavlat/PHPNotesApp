                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <div>
                            ...
                            <?php  else : ?>
                                <a href="/registration" class="<?= urlIs('/registration') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium"> Register </a>
                    ...
                    <?php if($_SESSION['user'] ?? false): ?>
                        <div class="ml-3">
                            <form class="mt-3" method="POST" action="/session">
